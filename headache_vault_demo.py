...
<body>
    <div class="container">
        <div class="header">
            <h1>📋 Your Prior Authorization Letter</h1>
        ...
        <div class="content">
            ...
            <div class="tips">
                ...
                <div class="tips-content">
                    • Review and customize patient-specific details before submitting<br>
                    • Include supporting documentation (office notes, headache diary)<br>
                    • Keep a copy for your records with submission date<br>
                    • Follow up if no response within the payer's stated turnaround time
                </div>
            </div>
        </div>
        <div class="footer">
            ...
            <p style="margin-top: 16px; font-size: 11px; color: #9ca3af;">
                © 2026 Headache Vault • Built by a migraine patient, for the headache community
            </p>
        </div>
    </div>
</body>
...
def show_email_modal():
    ...
    with st.expander("📧 Email this PA to yourself", expanded=st.session_state.get('show_email_form', False)):
        st.markdown("""
        ...
        with col1:
            if st.button("📨 Send PA", key="send_email_btn", use_container_width=True):
...
"""
            ...
            with col2:
                if st.button("📧 Email to Me", key="email_pa", use_container_width=True):
